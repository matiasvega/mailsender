  ...
  function() {
	...
	$("#sim-edit-image .sim-edit-box-buttons-save").click(function() {
	  ...
	  $(this).parent().parent().slideUp(500)
          ...
          // agrego el upload de imagenes
            console.log('hacer el ajax upload!!!!!');
            var formData = new FormData($("#attachImageForm")[0]);                                                        
            console.log(formData);
            var formUrl = $("#attachImageForm").attr('action');
            console.log(formUrl);
            ...
            $.ajax({
                ...
                success: function(data,textStatus,xhr){
                        ...
                        console.log('xxxx');
                        var path = data;
                        big_parent.children('img').attr("src",path);
                },
